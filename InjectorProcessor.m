    ...
    methods
       ...
       % end
        ...
        function start(process)
            ...
            process.caculateHour.Period = 0.1;%循环间隔1秒
            ...
            process.caculateDay.Period = 0.1;%循环间隔1秒
